...
* Form - Allows users to input text via textbox, select radio buttons, checkboxes and submit their response. Validations is implemented for any input that uses a textbox.
...
* Form elements does not align properly.
